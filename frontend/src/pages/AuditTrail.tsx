  ...
  return (
    <div className="space-y-6">
      ...
      <section className="panel overflow-hidden p-0">
        <div className="flex items-center justify-between border-b border-slate-100 p-5 text-sm font-semibold text-slate-700">
            ...
            .map((event) => (
              ...
              >
                ...
                <div>
                  <Link
                    to={
                      event.case_id ? `/cases/${event.case_id}` : "/agent-runs"
                    }
